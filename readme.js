...
function parseFileContent(fileContent) {
	...
	// If there is no license, default to the None value.
	prompts.licenses.default = (license) ? Object.values(licenses).find(licenseType => licenseType.short === license)
	                                     : licenses.none;
